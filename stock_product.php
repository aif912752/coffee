...
?>
<?php
// ฟังก์ชันตรวจสอบว่าสินค้าใกล้หมดอายุภายในสามวันหรือไม่
function is_expiring_soon($expiration_date) {
    // แปลงวันหมดอายุจากข้อความเป็นวัตถุวันที่
    $expiration_date = date_create($expiration_date);
    // วันปัจจุบัน
    $current_date = date_create();
    // คำนวณวันที่หมดอายุ - วันปัจจุบัน
    $interval = date_diff($current_date, $expiration_date);
    // ถ้ามีน้อยกว่าหรือเท่ากับ 3 วัน คืนค่า true
...
<head>
    ...
    <script src="check_product_expiration.js"></script>
