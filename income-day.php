...
$sql = "SELECT i.*, a.username AS username
        ...
        WHERE DATE(i.datetime) = CURDATE()  -- กรองแถวที่มีวันที่ตรงกับวันปัจจุบัน
...
<body>
    <section class="container px-4 mx-auto">
        <div class="flex flex-col mt-6 ">
            ...
            <?php } else { ?>
                <tr>
                    <td class="px-4 py-4 text-sm font-medium whitespace-nowrap" colspan="4">ยังไม่มีรายได้สำหรับวันนี้</td>
                </tr>
