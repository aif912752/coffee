...
<body>
    <div class="container justify-center mt-5">
                    ...
                    <div class="payments">
                        ...
                        <div class="details">
                            ...
                            ?>
                                ...
                                ?>
                                    <span class="mb-1">(โปรโมชั่น: <?= $item['promotion_name'] ?></span> <span> ส่วนลด: <?= $item['discount_amount'] ?> บาท)</span> 
                                    <span>ราคาหลังลด: <?= $item['price'] - $item['discount_amount'] ?> บาท</span>
                            ...
                            ?>
                                    <span><?= implode(' <span> </span> ', $promotionNames) ?></span>
                                <?php
                                } else {
                                ?>
        ...
        <div class="card checkout">
            <div class="footer">
                <label class="price">$<?= $row['all_money'] ?></label>
